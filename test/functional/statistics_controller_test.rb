...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { concept: @statistic.concept, content: @statistic.content, editing: @statistic.editing, shots: @statistic.shots, user_id: @statistic.user_id, video_id: @statistic.video_id }
    end
  ...
  test "should update statistic" do
    put :update, id: @statistic, statistic: { concept: @statistic.concept, content: @statistic.content, editing: @statistic.editing, shots: @statistic.shots, user_id: @statistic.user_id, video_id: @statistic.video_id }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
